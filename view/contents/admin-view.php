...
<div class="container-fluid">
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <form action="<?php echo SERVERURL; ?>ajax/adminAjax.php" method="POST" data-form="save" class="formularioAjax" autocomplete="off" enctype="multipart/form-data">
                <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    ...
                                    <textarea name="direccion-reg" required="" class="form-control" rows="2" maxlength="100"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    <input class="form-control" required="" type="email" name="email-reg" maxlength="50">
                                </div>
                            </div>
                            <div class="col-xs-12">
