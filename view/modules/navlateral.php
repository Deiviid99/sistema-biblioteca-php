		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				<figure class="full-box">
					<img src="<?php echo SERVERURL; ?>view/assets/avatars/<?php echo $_SESSION["foto_sbp"]; ?>" alt="UserIcon">
				...
				<ul class="full-box list-unstyled text-center">
					...
					<li>
						<a href="<?php echo $logControlador->encriptar($_SESSION['token_sbp']); ?>" title="Salir del sistema" class="btn-exit-system">
